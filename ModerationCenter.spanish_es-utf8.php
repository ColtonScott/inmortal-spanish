...
$txt['mc_notes_delete_own'] = 'Sólo se le permite eliminar sus propias notas.';
$txt['mc_cannot_connect_sm'] = 'Usted no puede conectarse a simplemachines.org\'s para recibir el último archivo de noticias.';
...
$txt['mc_reported_users_none'] = 'No hay reportes pendientes de perfil.';
...
$txt['mc_reportedp_comment_delete'] = 'Eliminar';
...
$txt['mc_reportedp_new_comment'] = 'Añadir nuevo comentariot';
...
$txt['mc_viewmemberreport'] = 'Reportar perfil de %1$s';
$txt['mc_memberreport_summary'] = 'Ha habido %1$d reporte(s) relativo a este miembro. El último informe fue %2$s.';
$txt['mc_memberreport_whoreported_title'] = 'Miembros que han reportado a este miembro.';
...
$txt['report_action_message_saved'] = 'Ha creado con éxito un nuevo comentario.';
$txt['report_action_message_edited'] = 'Ha editado con éxito el comentario.';
$txt['report_action_message_deleted'] = 'El mensaje fue correctamente borrado.';
$txt['report_action_message_edit_issue'] = 'El mensaje que intenta editar no está disponible. Por favor, compruebe que no haya sido borrado.';
$txt['report_action_message_edit_cannot'] = 'Lo siento, usted no está autorizado a editar este comentario.';
$txt['report_action_message_delete_cannot'] = 'Lo siento, usted no está autorizado a eliminar éste comentario.';
$txt['report_action_message_delete_issue'] = 'El mensaje que intenta eliminar no está disponible. Por favor, compruebe que no haya sido borrado.';
...
// Do not use numeric entries in the below string.
$txt['mc_reportedm_ignore_confirm'] = '¿Seguro que desea ignorar más informes sobre este usuario? \\n\\n Esto desactivará nuevos informes para todo el mundo.';
$txt['mc_reported_members_title'] = 'Miembros reportados';
$txt['mc_reported_members_desc'] = 'Le permite ver una lista de todos los usuarios cuyos perfiles se han reportado';
